...
import { additionalBonusTypes, damageTypes, neededAttributes } from "../../../types/itemDescription";
    ...
    <>
      {itemInfo ? (
        <View style={equipmentStyles.container}>
          <Text style={[text.medium, equipmentStyles.title]}>{itemInfo.name}</Text>
          <View style={equipmentStyles.itemInfo}>
         <ItemInfoPreview data={itemInfo.damage} description={damageTypes}/>
         <ItemInfoPreview data={itemInfo.attributes} description={neededAttributes}/>
         <ItemInfoPreview data={itemInfo.additional} description={additionalBonusTypes}/>
          </View>
          ...
          <Image source={{ uri: itemInfo.image }} style={equipmentStyles.image} />
        </View>
      ) : (
